...
#ifndef AVE_MEDIA_FOUNDATION_VP9_VP9_GLOBALS_H_
#define AVE_MEDIA_FOUNDATION_VP9_VP9_GLOBALS_H_
...
constexpr int16_t kMaxOneBytePictureId = 0x7F;    // 7 bits
constexpr int16_t kMaxTwoBytePictureId = 0x7FFF;  // 15 bits
constexpr uint8_t kNoSpatialIdx = 0xFF;
constexpr uint8_t kNoGofIdx = 0xFF;
constexpr uint8_t kNumVp9Buffers = 8;
constexpr size_t kMaxVp9RefPics = 3;
constexpr size_t kMaxVp9FramesInGof = 0xFF;  // 8 bits
constexpr size_t kMaxVp9NumberOfSpatialLayers = 8;

constexpr int32_t kMinVp9SpatialLayerLongSideLength = 240;
constexpr int32_t kMinVp9SpatialLayerShortSideLength = 135;
...
#endif  // AVE_MEDIA_FOUNDATION_VP9_VP9_GLOBALS_H_
