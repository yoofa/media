/*
 * video_layers_allocation.h - Video layers allocation
 *
...
#ifndef AVE_MEDIA_FOUNDATION_VIDEO_LAYERS_ALLOCATION_H_
#define AVE_MEDIA_FOUNDATION_VIDEO_LAYERS_ALLOCATION_H_
...
#endif  // AVE_MEDIA_FOUNDATION_VIDEO_LAYERS_ALLOCATION_H_
