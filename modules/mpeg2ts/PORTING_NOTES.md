...
- Uses `foundation/bit_reader.h` (`ave::media::BitReader`) for bitstream parsing
- Uses `base/logging.h` with `AVE_LOG(...)`
- Removed Android-specific utility assumptions that do not exist in this tree
