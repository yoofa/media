 ...
 */
#ifndef AVE_MODULES_RTP_RTCP_SOURCE_RTCP_PACKET_H_
#define AVE_MODULES_RTP_RTCP_SOURCE_RTCP_PACKET_H_
...
//
//  base::Buffer packet = fir.Build();    // Returns a Buffer holding
...
//  base::Buffer packet = compound.Build();
...
class RtcpPacket {
 public:
  ...
  // Calls PacketReadyCallback if remaining buffer is too small
  // and assume buffer can be reused after callback returns.
...
#endif  // AVE_MODULES_RTP_RTCP_SOURCE_RTCP_PACKET_H_
