...
#ifndef AVE_MODULES_RTP_RTCP_SOURCE_ABSOLUTE_CAPTURE_TIME_SENDER_H_
#define AVE_MODULES_RTP_RTCP_SOURCE_ABSOLUTE_CAPTURE_TIME_SENDER_H_
...
class AbsoluteCaptureTimeSender {
 public:
  ...
  static constexpr base::TimeDelta kInterpolationMaxError =
      base::TimeDelta::Millis(1);

  explicit AbsoluteCaptureTimeSender(base::Clock* clock);
...
#endif  // AVE_MODULES_RTP_RTCP_SOURCE_ABSOLUTE_CAPTURE_TIME_SENDER_H_
