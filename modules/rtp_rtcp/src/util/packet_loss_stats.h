...
#ifndef AVE_MODULES_RTP_RTCP_SOURCE_PACKET_LOSS_STATS_H_
#define AVE_MODULES_RTP_RTCP_SOURCE_PACKET_LOSS_STATS_H_
...
#endif  // AVE_MODULES_RTP_RTCP_SOURCE_PACKET_LOSS_STATS_H_
