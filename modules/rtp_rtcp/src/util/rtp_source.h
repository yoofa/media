...
#ifndef AVE_MODULES_RTP_RTCP_SOURCE_RTP_SOURCE_H_
#define AVE_MODULES_RTP_RTCP_SOURCE_RTP_SOURCE_H_
...
class RtpSource {
 public:
  ...
  RtpSource(base::Timestamp timestamp,
            uint32_t source_id,
  ...
  base::Timestamp timestamp() const { return timestamp_; }
  ...
  std::optional<base::TimeDelta> local_capture_clock_offset() const {
...
#endif  // AVE_MODULES_RTP_RTCP_SOURCE_RTP_SOURCE_H_
