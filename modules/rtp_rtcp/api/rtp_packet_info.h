...
#ifndef AVE_MODULES_RTP_RTCP_INCLUDE_RTP_PACKET_INFO_H_
#define AVE_MODULES_RTP_RTCP_INCLUDE_RTP_PACKET_INFO_H_
...
class RtpPacketInfo {
 public:
  ...
  RtpPacketInfo(const RTPHeader& rtp_header, base::Timestamp receive_time);
  ...
  base::Timestamp receive_time() const { return receive_time_; }
  void set_receive_time(base::Timestamp value) { receive_time_ = value; }
  ...
  const std::optional<base::TimeDelta>& local_capture_clock_offset() const {
 ...
 private:
  ...
  std::optional<base::TimeDelta> local_capture_clock_offset_;
};
...
#endif  // AVE_MODULES_RTP_RTCP_INCLUDE_RTP_PACKET_INFO_H_
