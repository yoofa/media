...
/**
 * Default {@link AudioSink} implementation backed by Android
 * {@link AudioTrack} in streaming mode ({@code MODE_STREAM}).
 *
 * <p>Currently supports PCM output only. Offload and tunnel modes will be
