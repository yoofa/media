...
H264Specific* VideoCodecProperty::H264() {
  AVE_DCHECK(codec_id == CodecId::AVE_CODEC_ID_H264);
...
H265Specific* VideoCodecProperty::H265() {
  AVE_DCHECK(codec_id == CodecId::AVE_CODEC_ID_HEVC);
...
VP8Specific* VideoCodecProperty::VP8() {
  AVE_DCHECK(codec_id == CodecId::AVE_CODEC_ID_VP8);
...
VP9Specific* VideoCodecProperty::VP9() {
  AVE_DCHECK(codec_id == CodecId::AVE_CODEC_ID_VP9);
